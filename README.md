...
- [**chat-like-human-memory**](https://github.com/nskit-io/chat-like-human-memory) — 8D emotion tracking + personality evolution + 3-tier memory
...
NVatar is an independent R&D project building the next generation of AI avatar interaction. Built by a solo founder at Neoulsoft Inc. — independent R&D, no external funding yet.
